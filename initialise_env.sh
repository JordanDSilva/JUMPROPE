...
export JUMPROPE_REF_DIR='' ## I recommend you keep this uncommented. Only add when you are certain the directory structure has been made. The code will auto prompt you to create it on first run.
