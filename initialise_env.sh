...
export JUMPROPE_REF_DIR='/Volumes/RAIDY/JWST' ## I recommend you keep this commented. Only add when you are certain the directory structure has been made. The code will auto prompt you to create it on first run.
export JUMPROPE_RAW_DIR='/Volumes/RAIDY/JWST/Imaging/PEARLSV2'
